/* $Id: js_perso_accesskey.js,v 7.00 2016/05/20 11:41:01 mr Exp $ */
    function acc_key(thi,event,xsib,xspo,xchi,xmod_ind,xadd_par,xadd_fam,xmod_fam) {
      ...
      var anc_tree_h7 = (document.getElementById("anc_tree_h7")) ? document.getElementById("anc_tree_h7") : thi;
      ...
      switch (charKey)
      {
        ...
        case "H": anc_tree_h7.click(); break;
