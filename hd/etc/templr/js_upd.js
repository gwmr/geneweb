/* $Id: js_upd.js,v 7.00 2016/04/03 22:49:31 mr Exp $ */
  function oKP1(event)
  {
  ...
  function oKP2(event,z2,z3,z4,z5)
  {
    ...
    if (z2 == "e")
    {
      var r = /[LMNST]/; /* lettres choisies */
      var t = r.test(charKey);
      if (t == true)
      { 
        switch(charKey)
        {
          case "L": document.getElementById("e_place" + z3).focus(); break;/* lieu */
          case "N": document.getElementById("e_note" + z3).focus(); break;/* note */
          case "S": document.getElementById("e_src" + z3).focus(); break;/* source */
          case "T": addWitness(1,1,z3); break;/* ajouter un témoin */
        }
        return false;        
      }
    }
