/* $Id: js_upd_jq.js,v 7.00 2016/04/26 22:19:33 mr Exp $ */
...
function jq1(z1,z2)
{
  ...
  if (v7 != "" || v8 != "")
  {
    ...
    if (e1.title != t1)
    {
      ...
      if (v7 != "")
      {
        var l = (u8 == "" || u8 == "?" || u9 == "?") ? g_prefix + "t=jquery;jq1=on;i=" + v7: g_prefix + "t=jquery;jq1=on;oc=" + v7 + ";p=" + u8 + ";n=" + u9;
        $("#jq").load(l, function()
        {
      ...
      {
        var l = g_prefix + "t=jquery;oc=0;p=" + u8 + ";n=" + u9 + ";jq1=on";
        $("#jq").load(l, function()
        {
          if(document.getElementById("jql"))
          {
...
function jq1a(z1)
{
  ...
  if (v7 != "" || v8 != "")
  {
    ...
    if (e1.title != t1 && (u8 != "?" || u9 != "?"))
    {
      ...
      if (v7 != "")
      {
        var l = (u8 == "" || u8 == "?" || u9 == "?") ? g_prefix + "t=jquery;jq1a=on;i=" + v7: g_prefix + "t=jquery;jq1a=on;oc=" + v7 + ";p=" + u8 + ";n=" + u9;
        $("#jq").load(l, function()
        {
          if(document.getElementById("jql"))
          {
      ...
      {
        var l = g_prefix + "t=jquery;oc=0;p=" + u8 + ";n=" + u9 + ";jq1a=on";
        $("#jq").load(l, function()
        {
          if(document.getElementById("jql"))
          {
...
function jq1b(z1)
{
  ...
  if (v8 != "")
  {
    ...
    if (u8 != "?" || u9 != "?")
    {
      var l = g_prefix + "t=jquery;jq1b=on;ifam=" + z1 + ";oc=" + v7 + ";p=" + u8 + ";n=" + u9;
      $("#jq").load(l, function()
      {
        if(document.getElementById("jql"))
        {
